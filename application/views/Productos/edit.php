...
<div class="card">
    ...
    <div class="card-body">
        <form class="row g-3 needs-validation" id="form-add-product" method="POST" action="<?= base_url('productos/guardar') ?>" novalidate>
            <div class="col-md-6">
                <input value="<?= $producto->id_producto ?>" type="hidden" name="id_producto">
                <label for="producto" class="form-label">Nombre</label>
                <input value="<?= $producto->producto ?>" type="text" class="form-control" id="producto" name="producto" required>
            ...
            <div class="col-md-6">
                ...
                <input value="<?= $producto->sku ?>" type="text" class="form-control" id="sku" name="sku">
                <div class="valid-feedback">
                    ¡Listo!
                </div>
            </div>
            <div class="col-md-4">
                ...
                <input value="<?= $producto->stock ?>" type="number" class="form-control" id="stock" name="stock" required>
                <div class="valid-feedback">
                    ¡Listo!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <input value="<?= $producto->precio ?>" type="number" class="form-control" id="precio" name="precio" required
                placeholder="0.00" min="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$">
                <div class="valid-feedback">
                    ¡Listo!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <input value="<?= $producto->stock_min ?>" type="number" class="form-control" id="stockmin" name="stockmin" required>
                <div class="valid-feedback">
                    ¡Listo!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" name="description" id="description" cols="30" rows="4"><?= $producto->descripcion ?></textarea>
                <div class="valid-feedback">
                    ¡Listo!
                </div>
            </div>
    ...
    $(function() {
        ...
        $('.submit-form-add-product').click(function() {
            if (forms.isValid() == false) {
                ...
                forms.addClass('was-validated');
                $.post(url + 'productos/guardar/edit', {
                    id_producto: $('#form-add-product input[name="id_producto"]').val(),
